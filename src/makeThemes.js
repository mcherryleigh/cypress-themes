...
// TODO mapping worked for bootstrap themes but may need adjusting with other sets warning/danger particularly
async function getColors(lessFile) {
  let colors = await c2j(lessFile) //?
  return {
    'grayDarker': '#222',
    'grayDark': '#333',
    'gray': '#555',
